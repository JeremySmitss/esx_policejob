...
Locales['nl'] = {
  ...
  ['test3'] = '--------------------------------------------------------------',
  ['entered_plane'] = 'Er is iemand in een vliegtuig gestapt. Er zijn nu %i mensen aanwezig in airspace',
  ['exited_plane'] = 'Er is iemand uit een vliegtuig gestapt. Er zijn nog %i mensen aanwezig in airspace',
  ...
  ['item_shop'] = 'ITEM SHOP WERKT NOG NIET',
  ...
  ['deleted_weapons'] = 'Vernietig Wapens',
  ...
  ['buy_items'] = 'Voorwerpen winkel',
  ['amount_invalid'] = 'Ongeldig of te hoog bedrag (max 200k)',
  ['object_store'] = 'Voorwerpen winkel',
  ...
  ['got_confiscated_weapon'] = 'Uw ~b~%s~s~ met ~o~%s~s~ kogels zijn in beslag genomen door ~y~%s~s~',
  ...
  -- Revive
  ['revive_inprogress'] = 'Je bent gestart met het reanimeren',
  ['revive_complete'] = 'Je heb de persoon ~g~succesvol~s~ gereanimeerd',
  ['player_not_unconscious'] = 'Deze persoon is niet dood'
}
